/**
 * MarCRM Import Script — 2026-07-01 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 6 new leads
 *   pr-marketing (4): Taktile, Nebex, Quantifind, Make
 *   fund-formation (2): Star51 Capital, Deep33
 *
 ...
 *   node scripts/import-2026-07-01.cjs            # insert missing leads
 *   node scripts/import-2026-07-01.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-01.json');
