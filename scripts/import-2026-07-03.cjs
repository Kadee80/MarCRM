/**
 * MarCRM Import Script — 2026-07-03 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 4 new leads
 *   pr-marketing (4): TwelveLabs, Probook, CarbonSix, Queue
 *
 ...
 *   node scripts/import-2026-07-03.cjs            # insert missing leads
 *   node scripts/import-2026-07-03.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-03.json');
