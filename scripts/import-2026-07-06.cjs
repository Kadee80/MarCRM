/**
 * MarCRM Import Script — 2026-07-06 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 1 new lead
 *   pr-marketing (1): OXMIQ Labs
 *
 ...
 *   node scripts/import-2026-07-06.cjs            # insert missing leads
 *   node scripts/import-2026-07-06.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-06.json');
