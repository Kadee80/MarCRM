/**
 * MarCRM Import Script — 2026-07-10 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 5 new leads
 *   pr-marketing  (4): Arca, Taktile, LinqAlpha, Bespoke Labs
 *   pr-freelance  (1): Avaans Media (Fractional VP PR)
 *
 ...
 *   node scripts/import-2026-07-10.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-10.json');
