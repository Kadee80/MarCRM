/**
 * MarCRM Import Script — 2026-06-30 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 5 new leads
 *   pr-marketing (4): Arca, Performativ, xCures, SquareFi
 *   legal-freelance (1): Tower Legal Solutions — Private Funds Contract Attorney
 *
 ...
 *   node scripts/import-2026-06-30.cjs            # insert missing leads
 *   node scripts/import-2026-06-30.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-06-30.json');
