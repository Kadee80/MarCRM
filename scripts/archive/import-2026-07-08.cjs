/**
 * MarCRM Import Script — 2026-07-08 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 5 new leads
 *   legal-freelance (1): Ontra
 *   pr-marketing  (4): Norm AI, EquiLibre Technologies, Jump, Agave
 *
 ...
 *   node scripts/import-2026-07-08.cjs            # insert missing leads
 *   node scripts/import-2026-07-08.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-08.json');
