/**
 * MarCRM Import Script — 2026-07-13 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 3 new leads
 *   pr-marketing  (3): Tangos, Kord, Infinia
 *
 ...
 *   node scripts/import-2026-07-13.cjs            # insert missing leads
 *   node scripts/import-2026-07-13.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-13.json');
