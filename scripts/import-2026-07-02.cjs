/**
 * MarCRM Import Script — 2026-07-02 (Prisma)
 * --------------------------------------------------------------
 * Daily scrape: 6 new leads
 *   pr-marketing (5): Pie, Higharc, LeapXpert, Omen AI, Float Financial
 *   legal-freelance (1): Larson Maddox — Private Funds / Fund Formation Counsel
 *
 ...
 *   node scripts/import-2026-07-02.cjs            # insert missing leads
 *   node scripts/import-2026-07-02.cjs --dry-run  # print plan, write nothing
 *
...
const REPORT = path.join(__dirname, '..', 'reports', 'daily-scrape-2026-07-02.json');
